...
void Suffer::SystemLight::Execute(GameObject* go) {
    ...
    // SHADOWS STUFF
        ...
        case Suffer::LightManager::LightKind::kLightKind_Point: {
            ...
            // Matrices stuff
            point_light->projection_mat_ = point_light->projection_mat_ .PerspectiveMatrix(ThiefUtils::Math::Radians(90.0f), (float)suffer.GetWindowSize().x_ / (float)suffer.GetWindowSize().y_, 1.0f, 25.0f);

            point_light->view_matrices_[0] = mathmorra::Matrix4::LookAt(point_light->Position(), mathmorra::Vector3(point_light->Position()) + mathmorra::Vector3( 1.0f,  0.0f,  0.0f), mathmorra::Vector3(0.0f, -1.0f,  0.0f));
            point_light->view_matrices_[1] = mathmorra::Matrix4::LookAt(point_light->Position(), mathmorra::Vector3(point_light->Position()) + mathmorra::Vector3(-1.0f,  0.0f,  0.0f), mathmorra::Vector3(0.0f, -1.0f,  0.0f));
            point_light->view_matrices_[2] = mathmorra::Matrix4::LookAt(point_light->Position(), mathmorra::Vector3(point_light->Position()) + mathmorra::Vector3( 0.0f,  1.0f,  0.0f), mathmorra::Vector3(0.0f,  0.0f,  1.0f));
            point_light->view_matrices_[3] = mathmorra::Matrix4::LookAt(point_light->Position(), mathmorra::Vector3(point_light->Position()) + mathmorra::Vector3( 0.0f, -1.0f,  0.0f), mathmorra::Vector3(0.0f,  0.0f, -1.0f));
            point_light->view_matrices_[4] = mathmorra::Matrix4::LookAt(point_light->Position(), mathmorra::Vector3(point_light->Position()) + mathmorra::Vector3( 0.0f,  0.0f,  1.0f), mathmorra::Vector3(0.0f, -1.0f,  0.0f));
            point_light->view_matrices_[5] = mathmorra::Matrix4::LookAt(point_light->Position(), mathmorra::Vector3(point_light->Position()) + mathmorra::Vector3( 0.0f,  0.0f, -1.0f), mathmorra::Vector3(0.0f, -1.0f,  0.0f));
